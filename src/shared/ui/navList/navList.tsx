                    ...
                    <div className={`${Class}__subMenu`}>
                      <ul className={`${Class}__subList`}>
                        {link.children.map((people, inx) => {
                          return <li  className={`${Class}__subItem`} key={inx}>
